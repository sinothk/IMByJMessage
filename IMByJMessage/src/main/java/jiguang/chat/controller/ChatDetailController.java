...
public class ChatDetailController implements OnClickListener, OnItemClickListener,
    ...
    public void onClick(View v) {
        ...
        }else if(v.getId() == R.id.group_name_ll){
            // 设置群组名称
            mContext.updateGroupNameDesc(mGroupId, 1);
        }else if(v.getId() == R.id.group_desc_ll){
            mContext.updateGroupNameDesc(mGroupId, 2);

        }else if(v.getId() == R.id.rl_groupAvatar){
        ...
        }else if(v.getId() == R.id.group_chat_del_ll){
            // 删除聊天记录
        ...
        }else if(v.getId() == R.id.tv_moreGroup){
        ...
        }else if(v.getId() == R.id.chat_detail_add_friend){
        ...
        }else if(v.getId() == R.id.chat_file){
