...
public class SendFileController implements View.OnClickListener, ViewPager.OnPageChangeListener,
    ...
    public void onClick(View view) {
        ...
        if (view.getId() == R.id.actionbar_file_btn) {
            mSFView.setCurrentItem(0);

        }else if(view.getId() == R.id.actionbar_video_btn){
            mSFView.setCurrentItem(1);

        }else if(view.getId() == R.id.actionbar_album_btn){
            mSFView.setCurrentItem(2);

        }else if(view.getId() == R.id.actionbar_audio_btn){
            mSFView.setCurrentItem(3);

        }else if(view.getId() == R.id.actionbar_other_btn){
