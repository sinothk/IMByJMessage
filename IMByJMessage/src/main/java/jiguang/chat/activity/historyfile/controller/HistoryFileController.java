...
public class HistoryFileController implements View.OnClickListener, ViewPager.OnPageChangeListener,
    ...
    public void onClick(View v) {
        ...
        if (v.getId() == R.id.actionbar_album_btn) {
            mSFView.setCurrentItem(0);

        }else if(v.getId() == R.id.actionbar_file_btn){
            mSFView.setCurrentItem(1);

        }else if(v.getId() == R.id.actionbar_video_btn){
            mSFView.setCurrentItem(2);

        }else if(v.getId() == R.id.actionbar_audio_btn){
            mSFView.setCurrentItem(3);

        }else if(v.getId() == R.id.actionbar_other_btn){
            mSFView.setCurrentItem(4);

        }else if(v.getId() == R.id.return_btn){
            mContext.finish();

        }else if(v.getId() == R.id.delete_file_btn){
            if (idMap.size() == 0) {
                return;
            }
            if (isGroup) {
        ...
        }else if(v.getId() == R.id.tv_choose){
            mSFView.setDeleteRl();
